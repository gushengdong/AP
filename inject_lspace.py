...
#deta_inj = 0.025 
	...
	bunch_inj = inj_dist.bunch(betax_inj,betay_inj,alphax_inj,alphay_inj,emitx_inj,emity_inj,number_per)
...
#acc 
	...
	bunch = lspace.space(bunch,16, 80.0,80.0,7.8e12,2000,200.0,2)
	bunch = tspace.space(bunch,16,16,16, 80.0,7.8e12,2000,200.0,2,l1001)
#for test long spacecharge
#	bunch = lspace.space(bunch,16, 80.0,80.0,7.8e12,2,2)
#	bunch = lspace.space(bunch,16, 80.0,80.0,7.8e12,2,2)
#	bunch = lspace.space(bunch,16, 80.0,80.0,7.8e12,2,2)
#	bunch = lspace.space(bunch,16, 80.0,80.0,7.8e12,2,2)
#	bunch = lspace.space(bunch,16, 80.0,80.0,7.8e12,2,2)
